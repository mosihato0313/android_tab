...
public class graph2 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final RadioButton button2 = findViewById(R.id.radio_input);
        button2.setOnClickListener(this);

        final RadioButton button3 = findViewById(R.id.radio_list);
